...
<table>
  ...
  <tr>
    ...
    <td><%=person.getFather_name()%></td>
    <td><%=person.getNc_number()%></td>
    <td><%=person.getCc_number()%></td>
    <td><%=person.getCreate_date()%></td>
    <td>
      <button onclick="edit(<%=person.getId()%>,<%=person.getName()%>)">Edit</button>
